...
// import '../orders/checkout_process_screen.dart';
// import 'widget/progress_food_item.dart';
...
//  "07347d44-7fc7-43f4-a548-616a4178d7b0";
  ...
  // getAllordersOngoing() async {
  //   // context.read<OrderHistoryCubit>().getUserOrders();
  //   allUserOrders = await context.read<OrderHistoryCubit>().getUserOrders();
  //   //  String status =
  //   //   await context.read<OrderHistoryCubit>().getUserOrders(restaurantCode);
  //   debugPrint("ALL ORDERS ==> $allUserOrders");
  //   orderID = allUserOrders![0].id;
  // }
                                    ...
                                    child: Padding(
                                      ...
                                      child: BlocProvider(
                                        create: (context) => inject<
                                          ...
                                          ..getUserFulfilledOrdes(
                                              pendingOrders[index].id!),
                                        child: BlocConsumer<OrderTrackCubit,
                                                OrderTrackState>(
                                            listener: (ctx, state) async {
                                          state.maybeWhen(
                                              orElse: () {},
                                              ...
                                              success: (orderlist) {
                                                ...
                                                // checkForOrderStatus(
                                                //     pendingOrders?.data?.orderStatus);
                                              });
                                        }, builder: (ctx, state) {
                                          return state.maybeWhen(
                                              orElse: () =>
                                                              ...
                                                              Padding(
                                                                ...
                                                                child: ListTile(
                                                                  ...
                                                                  trailing: Text(
                                                                      ...
                                                                      style: TextStyle(fontSize: 16.sp, fontWeight: FontWeight.w400, color: Palette.dukalinkBlack1)),
                                                                ),
                                                              ),
                                                              // Padding(
