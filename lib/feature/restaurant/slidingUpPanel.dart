...
class SlidingUpPanelView extends StatefulWidget {
  ...
  const SlidingUpPanelView({Key? key, required this.restaurantCode})
      : super(key: key);

  @override
  State<SlidingUpPanelView> createState() => _SlidingUpPanelViewState();
}
